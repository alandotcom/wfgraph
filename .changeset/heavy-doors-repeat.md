...
Choosing a connection is a dropdown, and creating, editing and deleting one
happen only in Settings > Connections. A connection changed there now repairs
the open graph, so a step stops naming a connection that was just deleted.
