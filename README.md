...
# Start local Postgres (optional, if you don't have Postgres running)
docker compose up -d
...
- **Acuity**: List Appointment Types, List Appointments, Get Appointment, Get Availability Dates, Get Availability Times, Create Appointment, Reschedule Appointment, Cancel Appointment
