...
How to author an integration against `@rova/core/plugin`: `defineIntegration`, replay safety, Effect vs Promise, config forms, testing, and step-boundary schemas.
