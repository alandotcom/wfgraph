ALTER TABLE `workflow_executions` ADD `entity_type` text;--> statement-breakpoint
ALTER TABLE `workflow_executions` ADD `entity_id` text;--> statement-breakpoint
ALTER TABLE `workflow_executions` ADD `termination_kind` text;--> statement-breakpoint
ALTER TABLE `workflow_executions` ADD `termination_requested_at` integer;--> statement-breakpoint
ALTER TABLE `workflow_executions` ADD `termination_reason` text;--> statement-breakpoint
ALTER TABLE `workflow_executions` ADD `termination_node_id` text;--> statement-breakpoint
