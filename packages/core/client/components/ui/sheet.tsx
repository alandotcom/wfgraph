    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Viewport className="fixed inset-0 z-50">
        <SheetPrimitive.Popup
          className={cn(
            "fixed z-50 flex flex-col gap-4 bg-background shadow-lg transition ease-in-out data-[closed]:animate-out data-[open]:animate-in data-[ending-style]:duration-300 data-[starting-style]:duration-500",
            side === "right" &&
