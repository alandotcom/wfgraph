...
/**
 * The durable arrival that moved a park out of `waiting`, or null when the row
 * does not record one. This also covers the first preparation before registration.
 *
