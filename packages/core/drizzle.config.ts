 ...
 *
 * Workflow Graph's tables are declared unqualified and the schema they live in comes from
 ...
 * Workflow Graph's own migrator, which is what carries the search_path.
 *
