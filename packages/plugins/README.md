...
Each integration is also exported as a factory by name, for a host that wants some of the five
rather than all of them. That narrows what reaches `createWfGraphApp` rather than what the
process loads, since this entry imports all five factories.
