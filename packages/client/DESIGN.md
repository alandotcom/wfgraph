...
| ---------------- | ------ | --------------------------------------- |
| Under 1024px     | 320px  | The canvas less 16px                    |
...
open Reveal. Closing returns to the camera from before Reveal opened
unless the person panned or zoomed in between, and moving between Browse and
Focus recomputes from that same starting camera. Below `md` the configuration
sheet replaces Canvas Reveal.
