  ...
  return (
    <>
      ...
      <aside
        ...
        className="canvas-reveal nokey absolute z-20 flex flex-col overflow-hidden rounded-xl border bg-sidebar shadow-sm transition-transform duration-150 ease-out"
        data-level={level}
