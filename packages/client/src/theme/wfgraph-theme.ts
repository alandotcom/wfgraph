...
/**
 * The editor's Astryx theme. The palette is pure neutral, so
 * `neutralStyle: "neutral"` generates the ramps and the overrides below pin
 * Workflow Graph's exact surface and text values.
 *
...
export const wfgraphTheme = defineTheme({
  ...
  tokens: {
    ...
    "--color-text-secondary": ["oklch(0.556 0 0)", "oklch(0.72 0 0)"],
